...
public class AccessRoleSpecifications implements Specification<AccessRoleEntity> {

    private final JSONObject criteria;

    public AccessRoleSpecifications(JSONObject criteria) {
        this.criteria = criteria;
    }

	public Predicate toPredicate(Root<AccessRoleEntity> root,
