...
public class AuditTrailSpecifications implements Specification<AuditTrailEntity> {

    private final JSONObject criteria;

    public AuditTrailSpecifications(JSONObject criteria) {
        this.criteria = criteria;
    }

	public Predicate toPredicate(Root<AuditTrailEntity> root,
