...
public class CodeConfigSpecifications implements Specification<CodeConfigEntity> {

    private final JSONObject criteria;

    public CodeConfigSpecifications(JSONObject criteria) {
        this.criteria = criteria;
    }

	public Predicate toPredicate(Root<CodeConfigEntity> root,
